...
import com.example.employeeinformation.dummy.DummyContent;
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(EmployeeDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(EmployeeDetailFragment.ARG_ITEM_ID, holder.mItem.id);
